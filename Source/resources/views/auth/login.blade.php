<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <x-laravelComponents.text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-laravelComponents.primary-button class="ms-3">
                {{ __('Log in') }}
